...
function meal_assets() {
	...
	wp_enqueue_style( 'theme-style', get_template_directory_uri() . '/assets/css/style.css', null, VERSION );
	...
	wp_enqueue_script( 'portfolio-js', get_template_directory_uri() . '/assets/js/portfolio.js', array(
		'jquery',
		'magnific-popup-js',
		'imagesloaded-js',
		'isotope-js'
